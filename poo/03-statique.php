...
<html lang="fr">
  <head>
    <title>Les propriétés et les méthodes statiques - cours programmation orientée objet</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
  ...
  <body>
    ...
    <div class="p-5 bg-light">
        <div class="container">
            ...
            <p class="lead text-center mt-3">Les propriétés et les méthodes statiques</p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12">
                ...
                <p>Les propriétés et méthodes statiques sont particulières, en effet ces dernières n'ont pas besoin d'être appliquées sur l'instanciation de notre classe, elles vont y être directement liées. Dés que l'on aura un nouvel objet il profitera de la méthode mais l nomenclature sera différente.</p>

                <h3 class="text-secondary text-center">Dans quel cas l'utiliser?</h3>

                <p><em>L'instanciation c'est faire un nouvel objet, une classe et on fait un <code>new=</code></em></p>
